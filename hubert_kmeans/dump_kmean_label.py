...
if __name__ == "__main__":
    ...
    parser.add_argument("--feat_dir", type=str, default='../data/ljspeech/semantic_feature')
    parser.add_argument("--split", type=str, default='ljspeech')
    parser.add_argument("--nshard", type=int, default=1)
    parser.add_argument("--rank", type=int, default=0)
    parser.add_argument("--km_path", type=str, default='../data/ljspeech/kmeans_model')
    parser.add_argument("--lab_dir", default='../data/ljspeech/km_semtok')
