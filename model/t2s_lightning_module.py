...
import torch
from model.t2s_model import Text2SemanticDecoder
...
class Text2SemanticLightningModule(pytorch_lightning.LightningModule):
    ...
    def training_step(self, batch: Dict, batch_idx: int):
        ...
        loss, acc = self.model.forward(batch['phoneme_ids'],
        ...
        self.log("acc_t2s_top10", acc, on_step=True, on_epoch=True, prog_bar=True)
    ...
    def validation_step(self, batch: Dict, batch_idx: int):
        ...
        torch.save(pred_semantic.detach().cpu(), f'eval/semantic_toks_{batch_idx}.pt')
        if batch_idx == 0:
            print('')
